...
List<DummyApiResponce> dummyApiResponceFromJson(String str) => List<DummyApiResponce>.from(json.decode(str).map((x) => DummyApiResponce.fromJson(x)));

String dummyApiResponceToJson(List<DummyApiResponce> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class DummyApiResponce {
  int id;
  String title;
  String description;
  Category category;
  ...
  factory DummyApiResponce.fromJson(Map<String, dynamic> json) => DummyApiResponce(
    id: json["id"],
    title: json["title"],
